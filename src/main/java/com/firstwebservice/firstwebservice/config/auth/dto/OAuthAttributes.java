package com.firstwebservice.firstwebservice.config.auth.dto;
...
public class OAuthAttributes {
    ...
    //1
    //OAuth2User에서 반환하는 사용자 정보는 Map이기 때문에 값 하나하나를 변환해 야만 한다.
    ...
    //가입할 때의 기본 권한을 GEST로 주기 위해서 role 빌더값에는 Role.GUEST를 사용한다.
